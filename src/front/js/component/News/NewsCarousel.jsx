      ...
      >
        ...
        <div className="carousel-inner ">
          <div className="carousel-item active">
            ...
            <div className="carousel-caption d-none d-md-block">
              <h2 className="title text-start">
                Washington Av. will be a pedestrian-only street every Sunday,
                starting in March
              </h2>
            </div>
          </div>
          <div className="carousel-item">
            ...
            <div className="carousel-caption d-none d-md-block">
              <h2 className="title text-start">
                The City is buying a total of 50 new electric trams to replace
                actual units
              </h2>
            </div>
          </div>
          <div className="carousel-item">
            <img src={BikeLane} className="d-block w-100" alt="Bike Lane" />
            <div className="carousel-caption d-none d-md-block">
              <h2 className="title text-start">
                A total of 40km of bike lane will be built next year around the
                city{" "}
              </h2>
            </div>
          </div>
